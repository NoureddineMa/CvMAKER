    ...
    return (
        <div className=" ">
            <div className="mt-[8rem]">
                <span className="border-2 font-semibold border-[#116A7B] px-5 py-4 rounded-3xl ">The <span className="text-[#116A7B]">#1 </span>Resume Builder </span>
                <h1 style={{ fontSize: '31px' }} className="mt-11 font-bold ">Use our free online resume builder to create a professional resume in minutes.</h1>
                <p className="text-sm mt-3">Create a professional resume in minutes with CvMaKer. Our step-by-step resume building tool has easy-to-use </p>
                <div className="flex flex-col lg:flex-row gap-4 mt-4">
                    <button className="bg-[#116A7B] px-8  py-3 text-white font-medium rounded-xl">Get Started</button>
