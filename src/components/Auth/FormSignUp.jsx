...
function FormSignUp() {
  return (
    <div>
      ...
      <h1 className=" flex justify-center text-center text-xs  leading-tight tracking-tight my-7 text-gray-500  dark:text-white">
      Welcome , Create Your Account and Get Acces To + 20 free Templates
            </h1>
            <form className="space-y-4 md:space-y-6" action="#">
                ...
                <Buttons  className="w-full text-white bg-[#2F8899] hover:bg-[#0f5866] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" content="Sign Up" />
                <p className="text-xs font-light text-gray-500 text-center dark:text-gray-400">
                    Don’t have an account yet? <Link to="/SignUp" className="font-medium text-[#2F8899] hover:underline ">Sign up</Link>
                </p>
            </form>
    </div>
  )
